...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/siddharth/hybrid_control/src/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/siddharth/hybrid_control/devel)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/siddharth/hybrid_control/install)
...
if(NOT "/home/siddharth/hybrid_control/devel/include;/home/siddharth/hybrid_control/src/velodyne/velodyne_pointcloud/include " STREQUAL " ")
  set(velodyne_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/home/siddharth/hybrid_control/devel/include;/home/siddharth/hybrid_control/src/velodyne/velodyne_pointcloud/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/siddharth/hybrid_control/src/velodyne/velodyne_pointcloud/${idir}'.  ${_report}")
    endif()
